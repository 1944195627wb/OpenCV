...
rect = (50,50,400,500)
cv2.grabCut(o,mask,rect,bgd,fgd,cv2.GC_INIT_WITH_RECT)
mask2 = cv2.imread("D:/photo/hand.png",0)
mask2Show = cv2.imread("D:/photo/hand.png",-1)
m2rgb =cv2.cvtColor(mask2Show,cv2.COLOR_BGR2RGB)
mask[mask2==0]=0
mask[mask2==255]=1
mask,bgd,fgd =cv2.grabCut(o,mask,None,bgd,fgd,5,cv2.GC_INIT_WITH_RECT)
